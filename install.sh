...
sudo apt-get install -y python-pil xinit scrot git fbi uzbl matchbox-window-manager supervisor x11-xserver-utils ttf-mscorefonts-installer xwit sqlite3 libnss3 python-pip python-dev python-simplejson uzbl sqlite3 omxplayer x11-xserver-utils libx11-dev watchdog chkconfig xosd-bin xserver-xorg-legacy xserver-xorg
